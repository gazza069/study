...
let config = {
    apiKey: "AIzaSyA_R-No3qNhI0-9k_7N5wf3pUERggOZ7xk",
    authDomain: "vue-nuxt-8fb73.firebaseapp.com",
    databaseURL: "https://vue-nuxt-8fb73.firebaseio.com",
    projectId: "vue-nuxt-8fb73",
    storageBucket: "",
    messagingSenderId: "70807345769",
    appId: "1:70807345769:web:73151a956ed70e52"
};
...
export default {
    ...
    methods:{
        ...
        add: function() {
            ...
            let self = this;
            let d = new Date();
            let dstr = d.getFullYear() + '_' + (d.getMonth() + 1) + '_' + d.getDate() + ' ' + d.getHours() + ':' + d.getMinutes() + ':' + d.getSeconds();
            let id = d.getTime();
            let data = {
                msg:this.msg,
    ...
    created: function(){
        if (firevase.auth().currentUser == null){
            this.login();
        }
